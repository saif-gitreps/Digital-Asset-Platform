...
const perks = [
   {
      ...
      description:
         "Get your assets instantly in your emails to download them right away.",
   },
   {
      name: "Guranteed Quality",
      icon: CheckCircle,
      description:
         "Every asset is verified by our team. If you are not satisfied with the asset, you can request a refund.",
   },
   {
      name: "Green planet",
      icon: Leaf,
      description: "We plant a tree for every asset sold.",
   },
];
